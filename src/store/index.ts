  ...
  chatPageList: [
    {
      ...
      chatList: [
        ...
        },
        {
          ...
          chapterId: 4,
          type: 'action',
          info: '这一天你正在大漠跟一只黄羊和一只野狗赛跑(其实是想打死黄羊吃肉)，你仗着速度决跑赢了野狗，但遗憾的是你没跑过黄羊，眼见你被黄羊用角顶着翻了几个跟头，突然黄羊不动了，你喘着粗气，惊魂未定，只听到有个声音:“小兄弟，你没事吧。”你吓了一跳，一抬头，只见一个身着紫色长衫，手持宝剑的女子，英姿飒爽，正关切地望着你，见你看他，爽朗一笑。你才知道她叫【林珀】，在得知你没爹没娘无亲无故之后，她把你带回了南京城。',
          area: '',
          time: '大明朝永乐六年（1408）',
        },
        {
